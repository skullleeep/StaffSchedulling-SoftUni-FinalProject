...
namespace StaffScheduling.Web.Extensions
{
	public static class UserManagerExtensions
	{
		...
		public static async Task<StatusReport> AddUpdateUserClaimAsync(this UserManager<ApplicationUser> userManager, ApplicationUser user, CustomClaimType claimType, string claimValue)
		{
			//Get existing claims
